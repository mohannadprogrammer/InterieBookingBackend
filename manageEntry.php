...
<html lang="en">
  ...
  <body>
    ...
    <form action="http://localhost/reserviation/addOrUpdate.php" method="get" style='margin-left:90%;margin-top:5%' class="form-inline">
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    $tab = $tab."<td>".$row['capicty']."</td>";
                    $tab = $tab."<td>".$row['phone']."</td>";
                    $tab = $tab."<td style='color:blue'>"."<form method = \"get\" action=\"http://localhost/reserviation/addOrUpdate.php\" class=\"form-inline\">".
