<?php
$view = "<form action=\"http://localhost/reserviation/addUniversity.php\" method=\"post\">";
    ...
    if(isset($_GET["id"])){
        ...
        $sql = "SELECT * FROM university where id = ".$_GET["id"];
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                $id=$row["id"];
                $view= "<form action=\"http://localhost/reserviation/updateUniversity.php\" method=\"post\">";
                $view =$view."<div class=\"form-group\">".
                            "<input type=\"hidden\" name=\"id\" value='$id' />".
                            "<input type=\"text\" class=\"form-control\" name=\"name\" placeholder=\"University Name\" value='".$row["name"]."'  required>".
                            "</div>".
                            "<div class=\"form-group\">".
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="card" style="margin: auto;margin-top: 2%;">
            ...
            <div class="card-header">Manage University</div>
            <div class="card-body">
